...
% Problem 1.31: Equilateral Triangle on the Unit Circle
...
% Problem 1.32: Inequality with Complex Numbers
...
% Problem 1.33: Equality Condition for Complex Difference
...
% Problem 1.34: Complex Circle in the Plane
...
% Problem 1.35: Argument of a Complex Number via Arctangent
...
% Problem Let the pseudo-ordering be $z_1 < z_2$ if $|z_1| < |z_2|$, or if $|z_1|=|z_2|$ and $\arg(z_1) < \arg(z_2)$. We check the order axioms.
...
% Problem 1.37: Order Axioms and Lexicographic Ordering on R^2
...
% Problem 1.38: Argument of a Quotient Using Theorem 1.48
...
% Problem 1.39: Logarithm of a Quotient Using Theorem 1.54
...
% Problem 1.40: Roots of Unity and Polynomial Identity
...
% Problem 1.41: Inequalities and Boundedness of cos z
...
% Problem 1.42: Complex Exponential via Real and Imaginary Parts
...
% Problem 1.43: Logarithmic Identities for Complex Powers
...
% Problem 1.44: Conditions for De Moivre’s Formula
...
% Problem 1.45: Deriving Trigonometric Identities from De Moivre’s Theorem
...
% Problem 1.46: Tangent of Complex Numbers
...
% Problem 1.47: Solving Cosine Equation
...
% Problem 1.48: Lagrange’s Identity and the Cauchy–Schwarz Inequality
...
% Problem 1.49: Polynomial Identity via DeMoivre’s Theorem
...
% Problem 1.50: Product Formula for sin
