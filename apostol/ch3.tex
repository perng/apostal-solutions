...
\begin{theorem}[Properties of Open and Closed Sets]
\begin{enumerate}
...
\textbf{Proof:} Suppose for contradiction that $S = \bigcap_{k=1}^{\infty} S_k$ where each $S_k$ is open. Let $S = \{x_1, x_2, \ldots\}$ be an enumeration of the rationals in $(0,1)$.
...
\begin{theorem}[Interior and Closure Relations]
\begin{enumerate}
